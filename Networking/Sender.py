...
class Sender:
    ...
    def __init__(self, sock: socket.socket, outgoingQueue: "queue.Queue", debugger,
                 packetLogSettings: PacketLogSettings) -> None:
        self.sock = sock
    ...
    def _sendPacket(self, packet):
        ...
        if self.packetLogSettings.shouldLog(packet.type):
            self.debugger.debug(self.packetLogSettings.formatLine("C>S", packet))
